...
export function checkGameStatus(cellValues) {
  ...
  // Nếu có trường hợp đúng thì lấy ra một phần tử trong chuỗi thỏa mãn ở trên. Trả về một object mà ở đó status tương ứng với X hay O thắng
  if (winSetIndex >= 0) {
  ...
  // Xử lý trường hợp end game: Đã điền hết mà chưa có người thắng.
  // const cellValues =['X','O','X','X','O','X','O','X','O']
